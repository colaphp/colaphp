...
namespace App\Bundles\Sms\API\Common;

use App\API\Common\Controllers\BaseController;
use App\Bundles\Sms\API\Common\Requests\SmsSendRequest;
...
{
    #[OA\Post(path: '/api/sms/common/sms/send', summary: '发送手机短信验证码', tags: ['短信'])]
